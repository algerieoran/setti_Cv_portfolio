...
// insertion d'une exeperience
if(isset($_POST['exeperience'])){
    //si on a reçu un nouvelle exeperience
    if($_POST['exeperience']!='' && $_POST['titre_exp']!='' && $_POST['stitre_exp']!='' && $_POST['dates_exp']!=''&& $_POST['description_exp']!='' && $_POST['']!=''){

        $experience = addslashes($_POST['experience']);
        $titre = addslashes($_POST['titre_exp']);
        $stitre = addslashes($_POST['stitre_exp']);
        $date = addslashes($_POST['dates_exp']);
        $desc = addslashes($_POST['description_exp']);
        $pdoCV -> exec("INSERT INTO t_experiences VALUES (NULL, '$experience', '$titre', '$stitre','$date', '$desc', '1')");
...
if(isset($_GET['id_experience'])){
    ...
    header("location: ../admin_back/experiences.php");
