...
<html lang="fr">
  ...
  <body id="page-top" class="bg-secondary">
    ...
    <!-- Parcours -->
    <section id="parcours" class="projects-section">  
    <!-- 1 - Experiences -->
    ...
    echo '</div>';/* fin div .row -----------fin experiences*/
    ...
    <?php
            ...
            echo '<div class="offset-sm-6 col-sm-6  timeline-item">';
                ...
                echo '</div>';/* fin div .row */
            echo '</div>';/* fin div .offset-sm-6 col-sm-6  timeline-item */
    echo '</div>';/* fin div .row  -------- formations*/
...
<?php
            ...
            $sql->execute();
            // echo '<img src="back/img/' . $ligne_loisir['photo'] . '" alt="">';
