      ...
      <div class="row" id="contatti">
        <div class="container mt-5">
          <div class="row" style="height:550px;">
            ...
            <h2 class="text-uppercase mt-3 font-weight-bold text-white">ME CONTACTER</h2>
              <p style="text-align: center;">
                 N'hésitez pas à me contacter par <a href="mailto:valerian@lepeule.fr">mail</a> (valerian@lepeule.fr)<br>par téléphone au <a href="tel:+33683355441">06 83 35 54 41</a><br> ou via le formulaire de contact ci-dessous<br><br></p>
            <div class="col-12 col-md-8 col-lg-6 pb-5"> 
              <form action="contact.php" method="post">
                <div class="card border-primary rounded-0">
                  ...
                  <div class="card-body p-3">
                    ...
                    <div class="form-group">
                      <div class="input-group mb-2">
                        ...
                        <input type="text" class="form-control" id="nom" name="nom" placeholder="nom y Apellido" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group mb-2">
                        ...
                        <input type="email" class="form-control" id="nom" name="email" placeholder="ejemplo@gmail.com" required>
                      </div>
                    </div>
                  ...
                  </div><!-- fin div .card-body p-3 -->

                </div><!-- fin div .card border-primary rounded-0 -->
              </form>
              <!--Form with header-->
            </form><!-- fin div .col-md-8 col-lg-6 pb-5 -->
          </div><!-- fin div .row -->
        </div><!-- fin div .container mt-5 -->
      </div><!-- fin div #contatti -->
    </section>
    <!-- Contact Section -->
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <textarea class="form-control" placeholder="Envoyer votre message" required></textarea>
                                    </div>
                                </div>
